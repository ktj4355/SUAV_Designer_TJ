...
AOAdb=linspace(2.5,1.5,length(rR));
AOAdb(find(rR==0.9):end)=linspace(AOAdb(find(rR==0.9)),0,length(AOAdb(find(rR==0.9):end)));
...
%% SJDesign Calculator
inputGeom=readmatrix("Geom4.xlsx");
